...
void init_offsets() {
    ...
    */
    ...
    if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Tue Nov 29 21:40:09 PST 2016; root:xnu-3789.32.1~4/RELEASE_ARM64_T7001") == 0) {
        ...
        rootvnode_offset = 0x5f20b8;
    } // iOS 10.1 & 10.1.1 (all A10 devices)
        ...
        allproc_offset = 0x5b4168;
        rootvnode_offset = 0x5ba0b8;
    } // iOS 10.1 & 10.1.1 (all A8 devices)
        ...
        allproc_offset = 0x5a4148;
        rootvnode_offset = 0x5aa0b8;
    } // iOS 10.1 & 10.1.1 (all A9 devices)
        ...
        rootvnode_offset = 0x5aa0b8;
    } // iOS 10.1 & 10.1.1 (all A7 devices)
        ...
        allproc_offset = 0x5ec178;
        rootvnode_offset = 0x5f20b8;
    } // iOS 10.0.1 && 10.0.2 (all A10 devices)
        ...
        rootvnode_offset = 0x5b60b8;
    } // iOS 10.0.1 && 10.0.2 (all A8 devices)
        ...
        allproc_offset = 0x5a4148;
        rootvnode_offset = 0x5aa0b8;
    } // iOS 10.0.1 && 10.0.2 (all A9 devices)
        ...
        allproc_offset = 0x5a4128;
        rootvnode_offset = 0x5aa0b8;
    } // iOS 10.0.1 && 10.0.2 (all A7 devices)
        ...
        allproc_offset = 0x5a4128;
        rootvnode_offset = 0x5aa0b8;
    } // iOS 10 beta 5 (all A7 devices)
    else if (strcmp(u.version, "MarijuanARM")) {
